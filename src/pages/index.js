...
import thirdImg from "../images/thirdLaptop.jpg";
import fourthImg from "../images/fourthLaptop.jpg";
import fifthImg from "../images/fifthLaptop.jpg";
...
const IndexPage = (props, { data }) => {
  ...
  useEffect(() => {
    ...
    //Images Animation
    // tl.from(firstImage, 1.2, { y: 200, ease: "power3.out" }, "Start");
      ...
      {data.allDatoCmsWork.edges.map(({ node: work }) => (
        ...
        <div className="container">
          <div className="hero-inner">
            ...
            <div className="wrap">
              <div className="cube" ref={el => (images = el)}>
